...
var Tarjeta = require("../models/Pagocomercio.model");
...
exports.getComercios = async function (query, page, limit) {
...
exports.createComercioM = async function (tarjeta) {
...
exports.createComercio = async function (tarjeta) {
  // Creating a new Mongoose Object by using the new keyword
...
exports.getComercioCUIT = async function (query, page, limit) {
  var options = {
    page,
    limit,
  };
...
exports.getComercioCUITEmpresa = async function (query, page, limit) {
  var options = {
    page,
    limit,
  };
...
// Recupero Usuario por CUIT Empresa
exports.getComercioCodigo = async function (query, page, limit) {
  var options = {
    page,
    limit,
  };
...
exports.updateComercio = async function (tarjeta) {
